...
var Modal = function () {
  function Modal(modalType) {
    ...
    this.openModalButton = (0, _jquery2.default)(".open-modal-" + modalType);
    this.modal = (0, _jquery2.default)(".modal-" + modalType);
...
var SlickCarousel = function () {
  function SlickCarousel(els) {
    _classCallCheck(this, SlickCarousel);

    this.carouselItem = (0, _jquery2.default)('.' + els);
    this.createCarousel();
  }
...
var StickyHeader = function () {
  function StickyHeader() {
    ...
    this.featuresBtn = (0, _jquery2.default)('.large-hero__text-content a.btn');
    this.headerBtn = (0, _jquery2.default)('.site-header a.btn');
    this.headerLogo = (0, _jquery2.default)('.logo img');
...
var slickSales = new _SlickCarousel2.default('slickSales');
var mobileMenu = new _MobileMenu2.default();
var modalRequisites = new _Modal2.default('requisites');
var modalSale = new _Modal2.default('sale');
var modalRules = new _Modal2.default('rules');
